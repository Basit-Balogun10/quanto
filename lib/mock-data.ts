...
export const personas: Record<string, Persona> = {
  ...
  user_chioma_7h4m: {
    id: "user_chioma_7h4m",
    name: "Chioma Adebayo",
    personaType: "Business Executive",
    accountNumber: "2850123456",
    avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Chioma",
    email: "chioma.adebayo@corporate.com",
    balance: 2850000,
    usualMonthlySpend: 1200000,
    currentSpend: 875000,
    savingsStreak: 2,
    month: 12,
    activatedFeatures: {
    ...
    transactions: [
      ...
      },
      {
        id: "tx_3",
        date: "2025-11-30",
        vendor: "Business Class Flight - London",
        amount: 850000,
        category: "travel",
        type: "debit",
        icon: "✈️",
      },
      {
        id: "tx_4",
        date: "2025-11-28",
        vendor: "Strategic Partnership Payment",
        amount: 1200000,
        category: "business",
        type: "debit",
        icon: "🤝",
      ...
      },
      {
        id: "tx_9",
        date: "2025-11-15",
        vendor: "Car Service & Maintenance",
        amount: 85000,
        category: "transport",
        type: "debit",
        icon: "🚗",
      },
      {
        id: "tx_10",
        date: "2025-11-12",
        vendor: "Private Health Insurance",
        amount: 220000,
        category: "health",
        type: "debit",
        icon: "🏥",
    ...
    quantoResponses: [
      {
        id: "flow_stress_detection",
        category: "preventive",
        title: "Stress Detection Active",
        message:
          "We monitor unusual stress patterns during large transfers for your security and peace of mind.",
        actionLabel: "Learn more",
        priority: "low",
        timestamp: new Date(Date.now() - 7200000).toISOString(),
        read: false,
        flowType: "stress_detection",
        flowData: {
          enabled: true,
          threshold: 500000,
        },
